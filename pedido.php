...
<body>
	...
	<div class="main-content">
		<div class="content-page">
			...
			<div class="p-line"><div>Representante:</div>Ventas Ruta del Sillar</div>
			<p><b>NOTA:</b> Para confirmar la compra debe realizar el deposito por le monto total, y enviar el comprobante al siguiente correo example@example.com o al número de whatsapp 955 666 333</p>
		</div>
	</div>
